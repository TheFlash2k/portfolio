...
date: '2023-12-07'
tags: ['rev', 'pcc-23', 'windows', 'kernel']
draft: false
...
This challenge was developed by me for the on-site finals of Pakistan Cyber Security Challenge, 2023. The attached file was a simple Windows Driver that had an encrypted flag embedded in it. However, the encryption scheme is not known. No one was able to solve it in the finals, but after finals, [72Ghoul](https://medium.com/@hexamine22) did (and his solution was 👌). So, I'll be telling you of 3 different solutions, each with a different difficulty level.

Before moving forward, let's that a look at the provided _hint_:
...
### Solution 2: _Reversing the algorithm_
...
### Solution 3: _Using Unicorn to emulate_ (Purely unintended)
