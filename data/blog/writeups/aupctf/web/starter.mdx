...
date: '2023-06-25'
tags: ['web', 'aupctf', 'source-code-analysis']
draft: false
  ...
  <body>
    ...
    <script>
      ...
      for (var i = 0; i < letters.length; i++) {
        ...
        letter.style.top =
          Math.floor(Math.random() * (window.innerHeight - letter.offsetHeight)) + 'px'
        letter.style.left =
          Math.floor(Math.random() * (window.innerWidth - letter.offsetWidth)) + 'px'
      }
    </script>
  </body>
</html>
