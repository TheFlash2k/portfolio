...
date: '2023-07-18'
tags: ['pwn', 'amateurctf23', 'elf', 'shellcode']
draft: false
...
But, there is a check, that the final binary _must be less than "79 bytes"_. Fortunately, this one was. Now, let's write a simple python pwntools script that will send this binary to the program/server
