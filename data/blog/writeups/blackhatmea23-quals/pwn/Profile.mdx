...
date: '2023-10-09'
tags: ['ctf', 'pwn', 'blackhatmea23', 'interger-overflow', 'printf', 'fsb']
draft: false
summary: Exploiting an integer overflow to overwrite got entries, get leaks with printf and then overwriting the GOT entry of `free` with `system` to get a shell.
---
