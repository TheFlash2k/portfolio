...
date: '2024-03-14'
tags: ['pwn', 'htb', 'cyber-apocalypse24', 'heap', 'unsorted-bin']
draft: false
summary: Utilizing unsorted bin to get a libc arena leak and calling system with user-controlled heap-chunk's data.
---
